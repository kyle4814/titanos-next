...
const META_DESCRIPTION = `New Australian privacy law hits 11 December 2026 — six obligations, not one, and fines up to AU$50M. I sort all six with your business in one working call. ${DISPLAY.PACK_PRICE}.`;
